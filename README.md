...
* **Cianuro**: el cianuro no favorece al rendimiento, sino que el deportista, luego de consumirlo queda como muerto, llenos de abulia y de marasmo. Con cianuro, el rendimiento sera 0 si el peso del deportista es 70 o menos. Si es mas que 70, entonces el rendimiento que aporta es es el 1% de la dosis consumida.(1% + la dosis)
...
Agregar a pepe, otro voluntario que inicialmente pesa 80, tiene 30 anios. Pepe debe poder cumpliar anios y se diferencia de tito en que para calcular su velocidad si tiene mas de 30 entonces le resta 10 de velocidad.
